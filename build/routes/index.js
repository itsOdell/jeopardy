...
router.post("/login", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, exists, passwordMatches, token, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, bcrypt.compare(password, exists.password)];
            case 2:
                ...
                token = jwt.sign({ username: exists.username }, JWT_SECRET);
