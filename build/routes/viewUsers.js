...
router.get("/:username", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var username, user, data, error_1;
...
router.get("/:username/:projectId", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var username, projectId, project, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                username = req.params.username, projectId = req.params.projectId;
                return [4 /*yield*/, User.findOne({ username: username }).select({ projects: { $elemMatch: { _id: projectId } } })];
            case 1:
                project = _a.sent();
